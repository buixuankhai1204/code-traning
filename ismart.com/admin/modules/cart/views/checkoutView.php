                            ...
                            <div id="order-review-wp" class="fl-right">
                                ...
                                <div class="detail">
                                    <table class="shop-table">
                                        ...
                                        <tbody>
                                        <?php foreach($check_item as $item) { ?>
                        <tr>
                            <td>
                                <a href="<?php echo $item['url']?>" title="" class="product_title"><?php echo $item['product_title'] ?><strong class="product-quantity">x<?php echo $item['qty'] ?></strong></a>
                            </td>
