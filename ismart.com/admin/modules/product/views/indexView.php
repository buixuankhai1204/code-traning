                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        <ul class="post-status fl-left">
                            <li class="all"><a href="">Tất cả <span class="count"><?php echo count($list_product); ?></span></a> |</li>
                            <li class="publish"><a href="">Đã đăng <span class="count">(51)</span></a> |</li>
                            <li class="pending"><a href="">Chờ xét duyệt<span class="count">(0)</span> |</a></li>
                            <li class="trash"><a href="?mod=product&action=delete_product">Thùng rác <span class="count">(<?php echo count(get_list_delete_product()); ?>)</span></a></li>
                        </ul>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tbody-thumb">
                                            <img src="public/uploads/<?php echo $item['product_thumb'] ?>" alt="">
                                        </div>
                                    </td>
                                    <td class="clearfix">
                                        <div class="tb-title fl-left">
                                            <a href="<?php echo $item['edit_url'] ?>" title=""><?php echo $item['product_title'] ?></a>
                                        </div>
                                    ...
                                    <td><span class="tbody-text"><?php echo $item['product_price'] ?></span></td>
