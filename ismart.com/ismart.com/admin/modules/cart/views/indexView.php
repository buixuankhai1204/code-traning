...
<div id="main-content-wp" class="cart-page">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td >
                                            <input data-id="<?php echo $item['id']; ?>" type="number"  name="qty[<?php echo $item['id'];  ?>]" min='1' max='10' value="<?php echo $item['qty']; ?>" class="num-order">
                                        </td>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="7">
                                        <div class="clearfix">
                                            <p  class="fl-right">Tổng giá: <span class="total-price"><?php echo currency_format(get_total_cart()); ?></span></p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
    ...
    ?>
        <p id="none-product">Không có sản phẩm nào trong giỏ hàng. Click <a href="?">vào đây</a> để quay trở lại Trang chủ.</p>
    <?php
    } ?>
</div>
<?php
