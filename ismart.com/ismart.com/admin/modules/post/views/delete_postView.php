                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        <ul class="post-status fl-left">
                            <li class="all"><a href="?mod=post&action=index">Tất cả <span class="count">(<?php echo count(get_list_post()); ?>)</span></a> |</li>
                    ...
                    <div class="table-responsive">
                        <table class="table list-table-wp">
                            ...
                            <?php
                            $t=0;
                            foreach($list_delete_post as $item){
                                ...
                                <tr>
                                    ...
                                    <td class="clearfix">
                                        ...
                                        <ul class="list-operation fl-right">
                                            ...
                                            <li><a href="<?php echo $item['remove_url'] ?>" title="Xóa" class="delete"><i class="fa fa-plus" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
