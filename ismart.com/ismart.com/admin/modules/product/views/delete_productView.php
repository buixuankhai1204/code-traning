                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        <ul class="post-status fl-left">
                            <li class="all"><a href="?mod=product">Tất cả <span class="count">(<?php echo count(get_list_product()); ?>)</span></a> |</li>
                            <li class="publish"><a href="">Đã đăng <span class="count">(51)</span></a> |</li>
                            <li class="pending"><a href="">Chờ xét duyệt<span class="count">(0)</span> |</a></li>
                            <li class="pending"><a href="?mod=product&action=delete">Thùng rác<span class="count">(<?php echo count($list_delete_product); ?>)</span></a></li>
                        </ul>
                    ...
                    <div class="table-responsive">
                        <table class="table list-table-wp">
                            ...
                            <?php
                            $t=0;
                             foreach($list_delete_product as $item) {
                                $t++;
                                ?>
                                <tr>
